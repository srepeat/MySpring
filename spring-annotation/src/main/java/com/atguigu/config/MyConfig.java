...
import com.atguigu.impor.MyImportBeanDefinitionRegistrar;
import com.atguigu.impor.MyImportSelecter;

@Configuration //使用配置的方式加载bean
@Conditional({WindowsConditional.class})
@Import({Red.class,MyImportSelecter.class,MyImportBeanDefinitionRegistrar.class})
